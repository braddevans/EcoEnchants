...
public class RarityLengthSorter extends PluginDependent<EcoEnchantsPluginImpl> implements EnchantmentSorter {
    /**
     * Instantiate sorter.
     *
     * @param plugin Instance of EcoEnchants.
     */
    public RarityLengthSorter(@NotNull final EcoEnchantsPluginImpl plugin) {
        super(plugin);
    }
