...
public class RarityAlphabeticSorter extends PluginDependent<EcoEnchantsPluginImpl> implements EnchantmentSorter {
    /**
     * Instantiate sorter.
     *
     * @param plugin Instance of EcoEnchants.
     */
    public RarityAlphabeticSorter(@NotNull final EcoEnchantsPluginImpl plugin) {
        super(plugin);
    }
